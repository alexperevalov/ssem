...
class user extends Home
{
    ...
    public function user()
    {
        ...
        $crud->columns('SL', 'username', 'first_name', 'last_name', 'email', 'mobile', 'user_type', 'status');
        $crud->add_fields('first_name', 'last_name', 'email', 'mobile', 'username', 'password', 'user_type', 'status');
        $crud->edit_fields('first_name', 'last_name', 'email', 'mobile', 'username', 'user_type', 'status');

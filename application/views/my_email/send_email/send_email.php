         ...
         <div class="box-body">	  
					...
					<?php
						foreach($groups_name as $group_id=>$group_name){	
							...
							foreach($contact_list as $list){
								...
								echo "<option value='{$email}'>{$f_name} {$l_name} ({$email})</option>";
							}
						echo "</optgroup>";
						}
					 ?>
		   ...
		   <div class="form-group">
             ...
             <div class="col-sm-9 col-md-9 col-lg-9">
              ...
              <textarea placeholder="<?php echo $this->lang->line('placeholder_1_email'); ?>" id="to_emails" name="to_emails" class="form-control"></textarea>

		 ...
		 <div class="form-group">
			  <label class="col-sm-3 control-label" for="contacts_mobile"> <?php echo $this->lang->line('Select Contacts')?></label>
			  	<div class="col-sm-9 col-md-6 col-lg-6">
					...
					<?php
						foreach($groups_name as $group_id=>$group_name){	
							$contact_list=$contacts_info[$group_id];
							...
							foreach($contact_list as $list){
								...
								echo "<option value='{$mobile}'>{$f_name} {$l_name} ({$mobile})</option>";
							}
						echo "</optgroup>";
						}
					 ?>
		   ...
		   <div class="form-group">
		    ...
		    <div class="form-group">
	             ...
	             <div class="col-sm-9 col-md-6 col-lg-6">
	              ...
	              <textarea placeholder="<?php echo $this->lang->line('placeholder_1_sms') ;?>" id="to_numbers" name="to_numbers" class="form-control"></textarea>
	             </div>
            </div>
				   ...
				   <select  id='message_template_send' class='form-control'>
					...
					<?php 
						foreach($sms_template as $info){
							...
							echo "<option value='{$message}'>{$template_name}</option>";
						}
					?>
					</select>
		  ...
		  <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
              ...
              <textarea placeholder="<?php echo $this->lang->line('If you don\'t want any template, type your custom message here'); ?>" id="message" name="message" class="form-control"></textarea>
